...
// @ts-nocheck
    ...
    let FacilityCapabilities = "FACILITY_ROOM_INSTANCE_INFO";
    let FaciltyType = "SPAWN_FACILITY_ROOM_INSTANCE";
    ...
    async function fetchData(){
        ...
        let response = await data_exchange(ReportCapabilities, "RequestForList", FacilityCapabilities);
...
<div class="main">
    <div class="dropdown-container">
        <label for="dropdown">Select a Facility Room:</label>
